# Log — Timeline 2nd Brain

#log #timeline

Timeline auto-capture dari [CLAUDE.md §7.1 & §7.2](<../CLAUDE.md>): entry **[WATCH]** (video/artikel yang ditonton) dan **[SESSION]** (sesi building krusial). Beda sama `log-YYYY-MM-DD.md` yang isinya catatan harian freeform.

Entry terbaru di paling bawah (append-only).
